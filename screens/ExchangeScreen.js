      ...
      return (
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <TextInput style={{width: '74%', height: 44, borderRadius: 2, paddingLeft: 10, fontSize:17, backgroundColor: '#eee', color: '#555'}} placeholder="Search videos by user" placeholderTextColor="#555" />
